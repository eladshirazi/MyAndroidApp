...
class AddStudentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val saveMessagTextViewe: TextView = findViewById(R.id.add_student_activity_save_message_text_view)
        ...
        saveButton.setOnClickListener {
            saveMessagTextViewe.text = "Name: ${nameEditText.text} Id: ${idEditText.text} is saved!"
        }
